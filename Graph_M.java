...
import java.io.*;
	...
	public class Graph_M 
	{
		...
		{
			System.out.println("\t NYC subway Map");
			System.out.println("\t------------------");
			System.out.println("----------------------------------------------------\n");
			ArrayList<String> keys = new ArrayList<>(vtces.keySet());
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			g.addVertex("Times Square-42nd Street");
			g.addVertex("Union Square");
			g.addVertex("Canal Street");
			g.addVertex("Herald Square");
			g.addVertex("Columbus Circle");
			g.addVertex("Bowery");
			g.addVertex("125th Street");
			g.addVertex("Astor Place");
			g.addVertex("Fulton Street");
			g.addVertex("Grand Central Terminal");
			g.addVertex("West 4th Street-Washington Square");
			g.addVertex("86th Street");
			g.addVertex("Lexington Avenue-59th Street");
			g.addVertex("14th Street-Union Square");
			g.addVertex("Penn Station");
			g.addVertex("Chambers Street");
			g.addVertex("Rockefeller Center");
			g.addVertex("Bowling Green");
			g.addVertex("23rd Street");
			g.addVertex("96th Street");
			
			g.addEdge("Times Square-42nd Street", "Union Square", 8);
			g.addEdge("Union Square", "Canal Street", 10);
			g.addEdge("Canal Street", "Herald Square", 8);
			g.addEdge("Herald Square", "Columbus Circle", 6);
			g.addEdge("Columbus Circle", "Bowery", 9);
			g.addEdge("Bowery", "125th Street", 7);
			g.addEdge("125th Street", "Astor Place", 6);
			g.addEdge("Astor Place", "Fulton Street", 15);
			g.addEdge("Fulton Street", "Grand Central Terminal", 6);
			g.addEdge("Grand Central Terminal", "West 4th Street-Washington Square", 7);
			g.addEdge("West 4th Street-Washington Square", "86th Street", 1);
			g.addEdge("86th Street", "Lexington Avenue-59th Street", 2);
			g.addEdge("Lexington Avenue-59th Street", "14th Street-Union Square", 5);
			g.addEdge("14th Street-Union Square", "Penn Station", 2);
			g.addEdge("Penn Station", "Chambers Street", 7);
			g.addEdge("Chambers Street", "Rockefeller Center", 8);
			g.addEdge("Rockefeller Center", "Bowling Green", 2);
			g.addEdge("Bowling Green", "23rd Street", 2);
			g.addEdge("23rd Street", "96th Street", 3);
		}
		...
		public static void main(String[] args) throws IOException
		{
			...
			{
				System.out.println("\t\t\t\t~~LIST OF ACTIONS~~\n\n");
				System.out.println("1. Display all subway stations on the map.");
				System.out.println("2. Show the subway Map");
				System.out.println("3. Retrieve the shortest distance between a 'source' station and a 'destination' station.");
				System.out.println("4. Retrieve the shortest time to travel from a 'source' station to a 'destination' station.");
				System.out.println("5. Find the shortest path (based on distance) from a 'source' station to a 'destination' station.");
				System.out.println("6. Find the shortest path (based on time) from a 'source' station to a 'destination' station.");
				System.out.println("7. Exit the Menu");
				System.out.print("\nPlease enter your choice from the list above(1 to 7) : ");
				int choice = -1;
				try {
				...
				case 4:
					...
					System.out.print("Enter the Destation station: ");
